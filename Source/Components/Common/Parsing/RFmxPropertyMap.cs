...
{
    /// <summary>
    /// Represents a single RFmx Property and the information needed to translate it from the incoming value to  
    /// </summary>
    ...
    public class RFmxPropertyMap<T>
    {
        private T value;
        ...
        /// <summary>
        /// Optional; use if the property cannot be directly mapped to the RFmx value. For example,
        /// mapping a string value to a specific RFmx enum. If this delegate is not specified (i.e. null) the value
        /// from the provider will be parsed directly to the type specified by <see cref="T"/>.
        /// </summary>
